...
# print("The data type for variable 'name' is:", type(name))
# print("The data type for variable 'age' is:", type(age))
# print("The data type for variable 'cash' is:", type(cash))
# print("The data type for variable 'sexy' is:", type(sexy))
...
print("The data type for variable 'nucamp_locations' is:", type(nucamp_locations))
